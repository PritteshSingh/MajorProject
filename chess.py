...
#         move = minimax(game, game.to_move, depth)[0]
    ...
    myobj = gTTS(text=move2str(move), lang='en', slow=False)
    print(move2str(move))
    myobj.save("AImove.mp3")
    
    playsound("AImove.mp3")
    os.remove("AImove.mp3")
...
def find_in_book(game):
    ...
    openings = []
    book_file = open("C:/Users/Prittesh Singh/Documents/Projects/voice-controlled-chess-main/code/book.txt")
